...
import { YMaps, Map, FullscreenControl, ZoomControl } from "react-yandex-map";
function Footer() {
        ...
        <div className={css.info}>
          <div className={css.contac_email_location_inst_and_other}>
            <div className={css.contac_email_location}>
              <div className={css.contact_email_location_mini}>
                <div className={css.mini_info}>
                  ...
                  <hr />
                  <a href="tel:+998901151333">
                    <p className={css.p_1}>+998901151333</p>
                  </a>
                </div>
                <div className={css.mini_info}>
                  <img className={css.phone} src={post} alt="" />
                  <hr />
                  <a href="mailto:info@sightex.uz">
                    <p className={css.p_1}>info@sightex.uz</p>
                  </a>
                </div>
                <div className={css.mini_info}>
                  ...
                  <hr />
                  <a
                    href="https://goo.gl/maps/nVuUyquYunqT6Wfv9"
                    target="_blank"
                  >
                    <p className={css.p_1}>
                      Massiv Yalong'och 119A, <br /> Toshkent
                    </p>
                  </a>
                </div>
              </div>
            ...
            <div className={css.inst_and_other}>
              <button className={css.sot_seti}>
                <img className={css.image_sot_seti} src={instagram} alt="" />
              </button>
              <button className={css.sot_seti_1}>
                <img className={css.image_sot_seti} src={telegram} alt="" />
              </button>
              <button className={css.sot_seti_1}>
                <img className={css.image_sot_seti} src={youtube} alt="" />
              </button>
              <button className={css.sot_seti_1}>
                <img className={css.image_sot_seti} src={facebook} alt="" />
              </button>
            </div>
          </div>
          <YMaps>
